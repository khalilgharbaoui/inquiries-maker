class CleaningInquiriesController < ApplicationController
  before_action :set_cleaning_inquiry, only: [:show, :edit, :update, :destroy]

  # GET /cleaning_inquiries
  # GET /cleaning_inquiries.json
  def index
    @cleaning_inquiries = CleaningInquiry.all
  end
  ...
  def create
    ...
    respond_to do |format|
      if @cleaning_inquiry.save
        format.html { redirect_to @cleaning_inquiry, notice: 'Cleaning inquiry was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @cleaning_inquiry.update(cleaning_inquiry_params)
        format.html { redirect_to @cleaning_inquiry, notice: 'Cleaning inquiry was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cleaning_inquiries_url, notice: 'Cleaning inquiry was successfully destroyed.' }
