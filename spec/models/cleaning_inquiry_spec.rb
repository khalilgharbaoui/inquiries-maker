...
RSpec.describe CleaningInquiry, type: :model do
  before(:all) do
    @inquiry = build(:cleaning_inquiry)
  end
  ...
  context 'inquiry type definition' do
    context 'is_moving_request' do
      ...
      it 'should not have is_moving_request set to true' do
        expect(@inquiry.is_moving_request).to_not be_truthy
      end
      it 'should have is_moving_request set to false' do
        expect(@inquiry.is_moving_request).to be_falsy
      end
      it 'is not valid without is_moving_request' do
        inquiry2 = build(:cleaning_inquiry, is_moving_request: nil)
        expect(inquiry2).to_not be_valid
      end
      it 'is valid when is_moving_request with set to false' do
        inquiry2 = build(:cleaning_inquiry, is_moving_request: false)
    ...
    context 'is_cleaning_request' do
      ...
      it 'is not valid without is_cleaning_request' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: nil)
        expect(inquiry2).to_not be_valid
      end
      it 'is not valid when is_cleaning_request with set to false' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: false)
        expect(inquiry2).to_not be_valid
      end
    end
    context 'is_cleaning_request && is_moving_request (combined_inquiry)' do
      it 'is_cleaning_request & is_moving_request should both be booleans' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: 'string', is_moving_request: '😇')
        expect(inquiry2).to_not be_valid
      end
      it 'is_cleaning_request = false & is_moving_request = true' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: false, is_moving_request: true)
        expect(inquiry2).to_not be_valid
      end
      it 'is_cleaning_request = true & is_moving_request = false' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: true, is_moving_request: false)
        expect(inquiry2).to be_valid
      end
      it 'is not valid is_cleaning_request & is_moving_request are both true' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: true, is_moving_request: true)
        expect(inquiry2).to_not be_valid
      end
      it 'is not valid is_cleaning_request & is_moving_request are both false' do
        inquiry2 = build(:cleaning_inquiry, is_cleaning_request: false, is_moving_request: false)
        expect(inquiry2).to_not be_valid
      end
    end
  end
  ...
  context 'client_salutation' do
    ...
    it 'is not valid without a client_salutation' do
      inquiry2 = build(:cleaning_inquiry, client_salutation: nil)
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not integers' do
      inquiry2 = build(:cleaning_inquiry, client_salutation: 1)
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not bools' do
      inquiry2 = build(:cleaning_inquiry, client_salutation: false)
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not arrays' do
      inquiry2 = build(:cleaning_inquiry, client_salutation: ['Herr'])
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not arrays with hashes' do
      inquiry2 = build(:cleaning_inquiry, client_salutation: [{}])
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts Mr, Mrs, Herr, Frau, M., Mme' do
      inquiry2 = build(:cleaning_inquiry, client_salutation: 'Meneer')
      expect(inquiry2).to_not be_valid
    end
  end
  ...
  context 'locale' do
    ...
    it 'is not valid without a locale' do
      inquiry2 = build(:cleaning_inquiry, locale: nil)
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not integers' do
      inquiry2 = build(:cleaning_inquiry, locale: 1)
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not bools' do
      inquiry2 = build(:cleaning_inquiry, locale: false)
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not arrays' do
      inquiry2 = build(:cleaning_inquiry, locale: ['de'])
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts strings not arrays with hashes' do
      inquiry2 = build(:cleaning_inquiry, locale: [{}])
      expect(inquiry2).to_not be_valid
    end
    it 'is only accepts de, en, fr' do
      inquiry2 = build(:cleaning_inquiry, locale: 'nl')
      expect(inquiry2).to_not be_valid
    end
  end
  ...
  context 'client_first_name & client_last_name' do
    ...
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_first_name: '  ', client_last_name: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is not valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_first_name: nil, client_last_name: nil)
      expect(inquiry2).to_not be_valid
    end
  end
  ...
  context 'client_email' do
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_email: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is not valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_email: nil)
      expect(inquiry2).to_not be_valid
    end
    ...
    it 'should really not be disposable' do
      inquiry2 = build(:cleaning_inquiry, client_email: 'dick@75hosting.com')
      expect(inquiry2).to_not be_valid
    end
    it 'can be subadressed' do
      inquiry2 = build(:cleaning_inquiry, client_email: 't.r.a.i+n.i.n.g@eduk8.me')
      expect(inquiry2).to be_valid
    end
    ...
    it 'should be of class <String> if used trough default ways' do
      inquiry2_email = build(:cleaning_inquiry).client_email
  ...
  context 'client_mobile' do
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_mobile: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is not be valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_mobile: nil)
      expect(inquiry2).to_not be_valid
    end
    ...
    it 'can take a pager' do
      ...
      iquery2 = build(:cleaning_inquiry, client_mobile: pager_number)
  ...
  context 'client_postal_code' do
    ...
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_postal_code: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is not valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_postal_code: nil)
      expect(inquiry2).to_not be_valid
    end
    it 'is valid with 4 numbers' do
      inquiry2 = build(:cleaning_inquiry)
    ...
    it 'its error messages should be "Zipcode is invalid" when NOT valid' do
      # Arrange
      # stub / mock / build
      inquiry2 = build(:cleaning_inquiry, client_postal_code: '33333')
      # Act
    ...
    it 'its error messages should be empty when valid' do
      # Arrange
      # stub / mock / build
      inquiry2 = build(:cleaning_inquiry, client_postal_code: '3000')
      # Act
      # do something with the method under test
      inquiry2.valid?
      # Assert
  ...
  context 'client_property_size' do
    ...
    it 'is not valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_property_size: nil)
      expect(inquiry2).to_not be_valid
    end
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_property_size: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is valid when filled with strings' do
    ...
    it 'is valid when in right size' do
      inquiry2 = build(:cleaning_inquiry, client_property_size: 'size_8')
      expect(inquiry2).to be_valid
    end
  end
  context 'client_city' do
    it 'is not valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_city: nil)
      expect(inquiry2).to_not be_valid
    end
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_city: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is valid when filled with strings' do
  ...
  context 'cleaning_date' do
    ...
    it 'is not valid when in the past' do
      inquiry2 = build(:combined_inquiry, cleaning_date: '2017-10-10')
      expect(inquiry2).to_not be_valid
    end
    it 'is valid when in the future' do
      inquiry2 = build(:combined_inquiry, cleaning_date: Faker::Date.forward(days = 365).to_formatted_s(:iso8601))
      expect(inquiry2).to be_valid
    end
  end
  ...
  context 'client_street_and_number' do
    it 'is not valid when nil' do
      inquiry2 = build(:cleaning_inquiry, client_street_and_number: nil)
      expect(inquiry2).to_not be_valid
    end
    it 'is not valid when empty' do
      inquiry2 = build(:cleaning_inquiry, client_street_and_number: '  ')
      expect(inquiry2).to_not be_valid
    end
    it 'is valid when filled with a string' do
    ...
    it 'it can not be valid with less than 3 in lenght' do
      inquiry2 = build(:cleaning_inquiry, client_street_and_number: 'a3')
      expect(inquiry2).to_not be_valid
    end
    it 'it is valid with 2 charachter or more' do
      inquiry2 = build(:cleaning_inquiry, client_street_and_number: 'abc 4')
      expect(inquiry2).to be_valid
    end
    ...
    it 'it validated that it contains numbers' do
      inquiry2 = build(:cleaning_inquiry, client_street_and_number: 'onlylettersstreet')
      expect(inquiry2).to_not be_valid
    end
  end
end
